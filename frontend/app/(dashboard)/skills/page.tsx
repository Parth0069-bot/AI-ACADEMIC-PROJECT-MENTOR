  ...
  return (
    <>
      ...
      <div className="px-6 md:px-10 pb-10 grid lg:grid-cols-3 gap-6">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex items-center gap-2 pt-2">
                <input
                  ...
                  className="flex-1 rounded-xl border border-primary-100 bg-surface px-3.5 py-2.5 text-sm outline-none focus:border-primary-400 focus:ring-2 focus:ring-primary-100"
                />
        ...
        <Card className="flex flex-col items-center text-center justify-center bg-gradient-to-b from-primary-50 to-surface">
