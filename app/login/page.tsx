...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // Supabase gives the same generic error for "wrong password" and
    // "no such account" on purpose (security). We check our own table
    // to tell the two cases apart and give a genuinely helpful message.
